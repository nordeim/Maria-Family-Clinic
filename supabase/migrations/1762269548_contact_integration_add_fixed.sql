-- Migration: contact_integration_add_fixed
-- Created at: 1762269548
...
-- Add foreign key constraints
ALTER TABLE "appointment_contact_integration" ADD CONSTRAINT "appointment_contact_integration_appointmentId_fkey" FOREIGN KEY ("appointmentId") REFERENCES "doctor_appointments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- Add foreign key constraints
ALTER TABLE "healthier_sg_contact_integration" ADD CONSTRAINT "healthier_sg_contact_integration_enrollmentId_fkey" FOREIGN KEY ("enrollmentId") REFERENCES "program_enrollments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- Program enrollment contact integration queries
